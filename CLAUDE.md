...
- **État** : 32 918 cartes Magic et 165 547 impressions, 1 028 decks ; 1 035 cartes Riftbound, cotées et adossées à 2 500 decks ; 13 866 cartes Yu-Gi-Oh et 44 139 impressions, cotées à 92,7 % et adossées à 3 935 decks — **le plus gros corpus des trois**. Les trois jeux bouclent la même promesse. **Les trois index d'empreintes sont pleins** — 1 035 Riftbound, 13 866 Yu-Gi-Oh, et 32 808 Magic sur 32 918 : les 110 manquantes n'ont aucune impression porteuse d'`illustration_id`, sans lequel rien ne dit si leur image a déjà été hachée, et sont écartées par construction. Collection réelle : 343 lignes, 451 exemplaires, aucune sans édition. Compte `buton1@live.fr`, mot de passe dans `../.deckhand-secrets/supabase.env`.
