...
- **Ce qui reste dû sur Wankul** : le gabarit d'illustration **horizontal**, mesuré sur une seule carte exploitable — la seconde connue est une édition Gold dont l'holographie déroute la détection. Le vertical, lui, est établi sur onze cartes par deux signaux concordants. Et le **format de carte** est présumé 63 × 88 sans vérification sur carton, seule entrée de la table dans ce cas.
