...
**La feuille penche du côté par lequel on la prend.** Une page saisie par un coin ne se lève pas comme une page saisie au milieu : le coin part le premier. `leafTilt` incline donc la feuille selon la hauteur de la **saisie** — retenue au début du geste et non suivie ensuite, sans quoi la feuille ondulerait au moindre tremblement de la main. Le pivot est posé sur la reliure, à cette hauteur : c'est le point qui ne bouge pas quand on tire une page par un coin. L'inclinaison naît et meurt avec le mouvement, comme la courbure — une feuille qui se pose est droite, sinon elle arriverait de travers sur la pile et y resterait. Elle plafonne à 0,11 radian (6°) : au-delà, la page paraît décrochée de sa reliure. La géométrie des lamelles n'est pas touchée — l'inclinaison s'applique par-dessus, le pliage reste le même et seule son assise change. Un changement de page par les flèches ou le menu, où il n'y a aucun doigt, vaut une saisie au milieu et ne penche rien.
