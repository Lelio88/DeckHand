...
const measuredFlatMatches = <MeasuredMatch>[
  ...
  MeasuredMatch("Captain Mar-Vell, Space-Born", "Captain Mar-Vell, Space-Born", 1.0000),
  ...
  MeasuredMatch("Okoye, cheffe des Dora Milaje", "Okoye, cheffe des Dora Milaje", 1.0000),
  MeasuredMatch("Croisade de Murdock", "Croisade de Murdock", 1.0000),
  MeasuredMatch("Oiseau Moqueur, agente de talent 3", "Oiseau Moqueur, agente de talent", 0.9394),
  ...
  MeasuredMatch("travail d'équipe, mettez un marqucur", "Transmetteur d'équipe", 0.3902),
  ...
  MeasuredMatch("S.HIELD, Üya des dizainer d'agents", "Agents du S.H.I.E.L.D.", 0.3611),
  MeasuredMatch("engeurs", "Vengeur en-Dal", 0.3529),
  MeasuredMatch("s deux i la place.", "Place de l'arche", 0.3462),
  MeasuredMatch("Vous controlez ont l'initiative,", "Saisir l'initiative", 0.3421),
  ...
  MeasuredMatch("Recyclage de terrain de base 2,dfse", "Don de terrain", 0.3235),
  MeasuredMatch("tate, ch? Knuckle", "Knucklebone Witch", 0.3077),
  MeasuredMatch("blescés.", "Blessing", 0.3077),
  MeasuredMatch("\"I came here to study the people of Earth,", "People of the Woods", 0.3043),
